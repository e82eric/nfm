...
public static class VirtualKeyCodes
{
    ...
    public const int VK_LMENU = 0xA4; // Left MENU key (ALT)
    public const int VK_RMENU = 0xA5; // Right MENU key (ALT)
    ...
    public const int VK_OEM_7 = 0xDE; // For the US standard keyboard, the 'single-quote/double-quote' key
